...
class TileBackground:
    ...
    def draw(self):
        self.window_left = clamp(25, int(server.boy.x) - self.canvas_width // 2, self.w - self.canvas_width - 1 - 25)
        self.window_bottom = clamp(25, int(server.boy.y) - self.canvas_height // 2, self.h - self.canvas_height - 1 - 25)
